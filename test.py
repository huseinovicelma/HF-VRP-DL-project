...
with open("results/results_50_6.csv", mode="a", newline="") as f:
        writer = None
        instance_path = f"dataset/r_50/r_50_70_30_70_6.txt"
        folder_path = "dataset/r_50"
        instance_name = 'r_50_70_30_70_6'
        params = get_parameters(instance_path)
...
with open("results/results_50_7.csv", mode="a", newline="") as f:
        writer = None
        instance_path = f"dataset/r_50/r_50_70_30_70_7.txt"
        folder_path = "dataset/r_50"
        instance_name = 'r_50_70_30_70_7'
        params = get_parameters(instance_path)
...
with open("results/results_50_8.csv", mode="a", newline="") as f:
        writer = None
        instance_path = f"dataset/r_50/r_50_70_30_70_8.txt"
        folder_path = "dataset/r_50"
        instance_name = 'r_50_70_30_70_8'
        params = get_parameters(instance_path)
...
with open("results/results_50_9csv", mode="a", newline="") as f:
        writer = None
        instance_path = f"dataset/r_50/r_50_70_30_70_9.txt"
        folder_path = "dataset/r_50"
        instance_name = 'r_50_70_30_70_9'
        params = get_parameters(instance_path)
